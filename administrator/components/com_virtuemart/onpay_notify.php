...
{ 
	...
	//Сообщаем ошибку
	if($error==1)
		$rezult=answer($_REQUEST['type'],2,$pay_for,$order_amount,$order_currency,
						'Error order_id:'.$order_id.' in order_id!=order_id, order_sum>sum or order_status!=P'); 
}
...
{ 
	...
	{ 
		...
		if(is_numeric($order_id)) 
		{
			...
			{
				$rezult = answerpay($_REQUEST['type'],3,
									$pay_for,$order_amount,$order_currency,
